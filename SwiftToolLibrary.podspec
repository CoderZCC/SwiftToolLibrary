#
#  Be sure to run `pod spec lint SwiftToolLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/CoderZCC/SwiftToolLibrary.git", :tag => "#{spec.version}" }
